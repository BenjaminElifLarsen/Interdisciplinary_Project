...
internal sealed class IsAnimalSpeciesNotInUse : ISpecification<Animalia>, ISpecification<RecogniseAnimal>
{
    ...
    {
        return !_species.Any(x => string.Equals(x, candidate.Species));//!string.Equals(_species, candidate.Species);
    }
